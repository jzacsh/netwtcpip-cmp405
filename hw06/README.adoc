...
:bugSendHang: https://github.com/jzacsh/netwtcpip-cmp405/blob/53735eeeb2/hw06/src/UsrNamesChannel.java#L111-L119
...
. if something i should know about messaging group that would
  {bugSendHang}[cause this hang to happen]
